...
const Contact = () => {
  return (
    <div className="w-full max-w-6xl mx-auto py-10 px-4">
      ...
      <h3 className="flex gap-2 text-xl font-semibold mt-4 mb-2"><FaMapMarkerAlt /> Address and Map</h3>
      ...
      <iframe
        ...
        width="1000"
        height="300"
        className="mx-auto border-0 mt-4"
        allowFullScreen
        loading="lazy"
      ...
      <h3 className="flex gap-2 text-xl font-semibold mb-4"><FaPhoneAlt /> Contact Information</h3>
        ...
        <table className="w-full text-sm text-center rtl:text-right text-body">
          ...
          <tbody>
            <tr className="border-b border-default">
              ...
              <td className="px-6 py-4"><a className="hover:underline" href="https://wa.link/pupyr1">+92 301 9613810</a></td>
            </tr>
            ...
            <tr className="border-b border-default">
              ...
              <td className="px-6 py-4"><a className="hover:underline" href="https://wa.link/dif090">+92 329 4715701</a></td>
            </tr>
            ...
            <tr className="border-b border-default">
              ...
              <td className="cursor-default px-6 py-4">08:00 AM – 02:00 PM</td>
            </tr>
            ...
            <tr>
              ...
              <td className="px-6 py-4"><a className="hover:underline" href="mailto:becomplex11@gmail.com">becomplex11@gmail.com</a></td>
            </tr>
          </tbody>
        </table>
      </div>
      ...
      <div className="flex justify-center gap-6 text-3xl">
        <a href="https://www.facebook.com/BodlaEducationalComplex/" target="_blank"><FaFacebook className="text-gray-600 hover:text-gray-800" /></a> 
        <a href="https://www.instagram.com/afzalassociates?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" target="_blank"><FaInstagram className="text-gray-600 hover:text-gray-800" /></a>
      </div>
    </div>
  );
};
